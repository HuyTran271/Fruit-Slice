...
import '../responsive/responsive.dart' as responsive;
...
class _LeaderboardScreenState extends State<LeaderboardScreen>
  ...
  late responsive.ResponsiveConfig config;
  ...
  Widget build(BuildContext context) {
    config = responsive.getResponsiveConfig(context);
      ...
      body: Container(
        ...
        child: SafeArea(
          child: Column(
            children: [
              Padding(
                padding: EdgeInsets.all(config.sidePadding),
                child: Row(
                  children: [
                    IconButton(
              ...
              GestureDetector(
                ...
                child: Container(
                  margin: EdgeInsets.symmetric(
                      horizontal: config.sidePadding, vertical: 10),
                  padding: EdgeInsets.symmetric(
                      horizontal: config.panelPadding, vertical: 12),
